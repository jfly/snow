...
class MiddlewareSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        MiddlewareSpec defines the desired state of a Middleware.
        :param 'MiddlewareSpecAddPrefixArgs' add_prefix: AddPrefix holds the add prefix middleware configuration. This middleware updates the path of a request before forwarding it. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/addprefix/
        :param 'MiddlewareSpecBasicAuthArgs' basic_auth: BasicAuth holds the basic auth middleware configuration. This middleware restricts access to your services to known users. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/basicauth/
        :param 'MiddlewareSpecBufferingArgs' buffering: Buffering holds the buffering middleware configuration. This middleware retries or limits the size of requests that can be forwarded to backends. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/buffering/#maxrequestbodybytes
        :param 'MiddlewareSpecChainArgs' chain: Chain holds the configuration of the chain middleware. This middleware enables to define reusable combinations of other pieces of middleware. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/chain/
        :param 'MiddlewareSpecCircuitBreakerArgs' circuit_breaker: CircuitBreaker holds the circuit breaker configuration.
        :param 'MiddlewareSpecCompressArgs' compress: Compress holds the compress middleware configuration. This middleware compresses responses before sending them to the client, using gzip compression. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/compress/
        ...
        :param 'MiddlewareSpecDigestAuthArgs' digest_auth: DigestAuth holds the digest auth middleware configuration. This middleware restricts access to your services to known users. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/digestauth/
        :param 'MiddlewareSpecErrorsArgs' errors: ErrorPage holds the custom error middleware configuration. This middleware returns a custom page in lieu of the default, according to configured ranges of HTTP Status codes. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/errorpages/
        :param 'MiddlewareSpecForwardAuthArgs' forward_auth: ForwardAuth holds the forward auth middleware configuration. This middleware delegates the request authentication to a Service. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/forwardauth/
        ...
        :param 'MiddlewareSpecRedirectSchemeArgs' redirect_scheme: RedirectScheme holds the redirect scheme middleware configuration. This middleware redirects requests from a scheme/port to another. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/redirectscheme/
        :param 'MiddlewareSpecReplacePathArgs' replace_path: ReplacePath holds the replace path middleware configuration. This middleware replaces the path of the request URL and store the original path in an X-Replaced-Path header. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/replacepath/
        :param 'MiddlewareSpecReplacePathRegexArgs' replace_path_regex: ReplacePathRegex holds the replace path regex middleware configuration. This middleware replaces the path of a URL using regex matching and replacement. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/replacepathregex/
        ...
        :param 'MiddlewareSpecStripPrefixArgs' strip_prefix: StripPrefix holds the strip prefix middleware configuration. This middleware removes the specified prefixes from the URL path. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/stripprefix/
        :param 'MiddlewareSpecStripPrefixRegexArgs' strip_prefix_regex: StripPrefixRegex holds the strip prefix regex middleware configuration. This middleware removes the matching prefixes from the URL path. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/stripprefixregex/
        """
...
class MiddlewareSpecBasicAuth(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        BasicAuth holds the basic auth middleware configuration. This middleware restricts access to your services to known users. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/basicauth/
        :param str header_field: HeaderField defines a header field to store the authenticated user. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/basicauth/#headerfield
...
class MiddlewareSpecBuffering(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str retry_expression: RetryExpression defines the retry conditions. It is a logical combination of functions with operators AND (&&) and OR (||). More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/buffering/#retryexpression
        """
...
class MiddlewareSpecErrors(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'MiddlewareSpecErrorsServiceArgs' service: Service defines the reference to a Kubernetes Service that will serve the error page. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/errorpages/#service
...
class MiddlewareSpecErrorsService(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'MiddlewareSpecErrorsServiceStickyArgs' sticky: Sticky defines the sticky sessions configuration. More info: https://doc.traefik.io/traefik/v2.9/routing/services/#sticky-sessions
...
class MiddlewareSpecInFlightReqSourceCriterion(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        SourceCriterion defines what criterion is used to group requests as originating from a common source. If several strategies are defined at the same time, an error will be raised. If none are set, the default is to use the requestHost. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/inflightreq/#sourcecriterion
        :param 'MiddlewareSpecInFlightReqSourceCriterionIpStrategyArgs' ip_strategy: IPStrategy holds the IP strategy configuration used by Traefik to determine the client IP. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/ipwhitelist/#ipstrategy
...
class MiddlewareSpecIpWhiteList(dict):
    ...
    def __init__(__self__, *,
                 ...
                 reject_status_code: Optional[int] = None,
                 source_range: Optional[Sequence[str]] = None):
        """
        IPWhiteList holds the IP whitelist middleware configuration. This middleware accepts / refuses requests based on the client IP. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/ipwhitelist/
        :param 'MiddlewareSpecIpWhiteListIpStrategyArgs' ip_strategy: IPStrategy holds the IP strategy configuration used by Traefik to determine the client IP. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/ipwhitelist/#ipstrategy
        :param int reject_status_code: RejectStatusCode defines the HTTP status code used for refused requests. If not set, the default is 403 (Forbidden).
    ...
    def reject_status_code(self) -> Optional[int]:
        """
...
class MiddlewareSpecRateLimitSourceCriterion(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        SourceCriterion defines what criterion is used to group requests as originating from a common source. If several strategies are defined at the same time, an error will be raised. If none are set, the default is to use the request's remote address field (as an ipStrategy).
        :param 'MiddlewareSpecRateLimitSourceCriterionIpStrategyArgs' ip_strategy: IPStrategy holds the IP strategy configuration used by Traefik to determine the client IP. More info: https://doc.traefik.io/traefik/v2.9/middlewares/http/ipwhitelist/#ipstrategy
        :param str request_header_name: RequestHeaderName defines the name of the header used to group incoming requests.
        :param bool request_host: RequestHost defines whether to consider the request Host as the source.
        """
        if ip_strategy is not None:
