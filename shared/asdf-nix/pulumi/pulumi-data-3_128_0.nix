...
{ }:
{
  ...
  pulumiPkgs = {
    x86_64-linux = [
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-artifactory-v7.5.0-linux-amd64.tar.gz";
        sha256 = "1jfzmyiizqb2kxf8d47fzk2rj405jjsn110p5w0hb9hkn7nk8f9h";
      }
      {
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-cloudflare-v5.35.1-linux-amd64.tar.gz";
        sha256 = "0svsmpfdf3avnfbcx3b401k4fgqc1r3qc6baw36wqk619szkqp99";
      }
      {
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-spotinst-v3.85.0-linux-amd64.tar.gz";
        sha256 = "1ksnkmhqs8ksjs29zjwls54lgbnzijdwzhj8f55r16h43fp9vpn2";
      }
      {
    ...
    x86_64-darwin = [
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-artifactory-v7.5.0-darwin-amd64.tar.gz";
        sha256 = "0kkai90wk46brx8dqfgkr6yj16hv3687mdmxwbj7xq9jc0gfr095";
      }
      {
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-cloudflare-v5.35.1-darwin-amd64.tar.gz";
        sha256 = "090p56bd0pd9dd1ymvl655bf6nmkwbp4jj9rpzsvd1bl0nwjhcq3";
      }
      {
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-spotinst-v3.85.0-darwin-amd64.tar.gz";
        sha256 = "0drbb82firhklirg7vk7ck5zqb292nfg37lxwdqp9jsrypj0ibmj";
      }
      {
    ...
    aarch64-linux = [
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-artifactory-v7.5.0-linux-arm64.tar.gz";
        sha256 = "11kr1y4zi5c69v2yy9d5n125n6mfxzdv9jyy8pszzajv0b2isck1";
      }
      {
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-cloudflare-v5.35.1-linux-arm64.tar.gz";
        sha256 = "12f7ximmz30nlqr2cpcdyhs7sl8l0y5j4zi8xciy476fm00sigxp";
      }
      {
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-spotinst-v3.85.0-linux-arm64.tar.gz";
        sha256 = "0xi1ddaa4c0pbcc68m336syph2nk6340z21l2sqnhvf3jd36smjf";
      }
      {
    ...
    aarch64-darwin = [
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-artifactory-v7.5.0-darwin-arm64.tar.gz";
        sha256 = "04xyp0sxxrd39s2z0f8hp87q9vkyjdv438ikkfbc1shhk2gfqpl5";
      }
      {
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-cloudflare-v5.35.1-darwin-arm64.tar.gz";
        sha256 = "05pm03j0jcg1yi959ry4z508198hp285jbz6mp6x7msdcr2bqdig";
      }
      {
      ...
      {
        url = "https://api.pulumi.com/releases/plugins/pulumi-resource-spotinst-v3.85.0-darwin-arm64.tar.gz";
        sha256 = "0b38af1ivqm3csfrdsac1iqs1dhdp8c7kkdndnjx84zsf6gfc5aw";
      }
      {
