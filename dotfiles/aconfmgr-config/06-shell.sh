...
# libutempter owns this file, and it's a dependency of mosh/tmux. I'm not sure
# if this permissions discrepancy is indicative of a bug somewhere.
...
AddPackage --foreign pkcrack # An algorithm for breaking the PkZip cipher that was devised by Eli Biham and Paul Kocher.
