# Generated by Powerlevel10k configuration wizard on 2022-03-27 at 22:56 PDT.
...
# 24h time, 2 lines, solid, left frame, white-ornaments, sparse, few icons, concise,
...
() {
  ...
  # NOTE: Disabled as a mitigation for "Horrific mess when resizing terminal
  # window" https://github.com/romkatv/powerlevel10k#mitigation
