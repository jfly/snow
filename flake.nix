  ...
  outputs =
    ...
    let
      ...
      inputs = patcher.patch unpatchedInputs {
        nixpkgs.patches = [
          (fetchpatch {
            name = "linux-manual: make kernel-doc.py and split-man.pl executable so patchShebangs doesn't skip them";
          ...
          (fetchpatch {
            name = "linux-manual: make kernel-doc.py and split-man.pl executable so patchShebangs doesn't skip them";
            url = "https://github.com/NixOS/nixpkgs/pull/430657.diff";
            hash = "sha256-GULPeAVLWk9XpKwINjItVxGVNYPWbmZOxCpmeNbVdPI=";
          })
        ...
        clan-core = {
          patches = [
            ...
            (fetchpatch {
              ...
              hash = "sha256-lDi8D+6OfxJKonppew1T7pzJjtIns7bO7Id6O21z+2g=";
            })
          ];
