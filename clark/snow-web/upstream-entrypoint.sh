#!/bin/sh
# Copied from https://github.com/nginx-le/nginx-le/blob/master/script/entrypoint.sh
# because
# https://github.com/nginx-le/nginx-le/commit/8fb55a9d4d0fcba655dbd5711108c35d74032156
# hasn't been released to docker hub yet.
echo "start nginx"
